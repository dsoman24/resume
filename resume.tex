...
\sectitle{Work Experience}
    ...
    \begin{experience}{Google}{Sunnyvale, CA}{Software Engineering (STEP) Intern}{May -- August 2023}
        ...
        \item Designed and implemented a novel data aggregation pipeline architecture which reduced signal implementation time by 50\% and eliminated boilerplate code.
