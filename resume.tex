...
\sectitle{Work Experience}
    ...
    \begin{experience}{Google}{Sunnyvale, CA}{Software Engineering (STEP) Intern}{May 2023 -- Present}
        ...
        \item Signals used to enhance the user and business web-domain knowledge base for Google Workspace's Growth \& Revenue Optimization team's machine learning models, utilized for setting account pricing and predicting account downgrades % more impact, did i improve model performance? did I add X new features/signals?
    \end{experience}
    ...
    \begin{experience}{Georgia Tech College of Computing}{Atlanta, GA}{Undergraduate Teaching Assistant (Homework Lead)}{August 2022 -- Present}
        ...
        \item Grading 4 exams per semester and writing auto-grader unit tests for assignments using the Java Reflection library % delete this!
    \end{experience}
...
\sectitle{Leadership and Involvement}
    ...
    % \begin{experience}{Consult Your Community}{Atlanta, GA}{Business Analyst}{December 2021 -- December 2022}
    ...
    %     \item Drafted social media and search engine optimization strategy report to be used by the client in the next calendar year
    % \end{experience}
