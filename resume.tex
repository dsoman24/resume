...
\sectitle{Work Experience}
    ...
    \begin{experience}{Google}{Sunnyvale, CA}{STEP Intern}{May -- August 2023}
        \item Built and tested an efficient parallel-processing data pipeline using FlumeJava, a Java MapReduce framework, to extract and aggregate over 70 business-useful web domain level signals from the HTML of more than 500 billion web pages.
        \item Designed and implemented a novel scalable and extensible data aggregation architecture which reduced signal implementation time by 50\% and eliminated boilerplate code.
        \item Refactored pipeline to improve reliability by developing a system to flush intermediate output to disk across 10k+ threads during a full table scan, saving up to 7 days of progress during each pipeline execution.
