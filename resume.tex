...
\sectitle{Work Experience}
    ...
    \begin{experience}{Google}{Sunnyvale, CA}{STEP Intern}{May -- August 2023}
        \item Built and tested an efficient parallel-processing data pipeline using FlumeJava, a Java MapReduce framework, to extract and aggregate over 70 business-useful web domain level signals from the HTML of over 500 billion web pages.
