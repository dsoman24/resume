...
\sectitle{Work Experience}
    ...
    \begin{experience}{Google}{Sunnyvale, CA}{STEP Intern}{May -- August 2023}
        \item Built and tested an efficient parallel-processing data aggregation pipeline using FlumeJava and MapReduce frameworks to extract over 50 useful web-domain level signals from raw HTML content of over 500 billion web pages.
