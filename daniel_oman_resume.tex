...
\sectitle{Experience}
    ...
    \begin{experience}{Ditch}{Atlanta, GA}{Software Engineering Intern}{September 2024 -- Present}
        ...
        \item Implement custom personalization systems leveraging Python, Firebase PostgreSQL, and OpenAI LLM APIs to provide users with personalized app experiences, leading to a decrease in user churn by 20\% and an increase in user engagement by 30\%.
    \end{experience}
