...
{B.S. Computer Science, concentrations in Intelligence (AI/ML) and Theory $|$ 4.0/4.0 GPA \\ \textit{Relevant Coursework}: Data Structures \& Algorithms, Computer Organization \& Programming, Probability \& Statistics, Combinatorics, Linear Algebra \& Vector Spaces, Machine Learning*, Design \& Analysis of Algorithms* (\textit{* = current})}
