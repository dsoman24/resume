...
\sectitle{Experience}
    ...
    \begin{experience}{Google}{Kirkland, WA}{Software Engineering Intern}{May -- August 2024}
        \item Design and implementat a distributed load testing framework using C++ and Python to gauge scalability of a novel data streaming service and write-ahead log within Google BigQuery's core infrastructure.
        ...
        \item Engineering custom monitoring dashboards, allowing for 3x faster detection of critical performance regressions.
    \end{experience}
