...
\sectitle{Experience}
    ...
    \begin{experience}{Ditch}{Atlanta, GA}{Software Engineering Intern}{September 2024 -- Present}
        ...
        \item Lead development of an automated notification scheduling, query, and delivery service using Python, Firebase PostgreSQL, and notification history frontend with Dart, increasing app engagement and reducing user onboarding churn by $\sim$20\%.
    \end{experience}
