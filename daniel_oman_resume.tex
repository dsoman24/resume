...
\sectitle{Experience}
    ...
    \begin{experience}{Company}{Location}{Software Engineering Intern}{May -- August 2024}
        \item Achieved X by doing Y, with impact Z.
        \item Achieved X by doing Y, with impact Z.
        \item Achieved X by doing Y, with impact Z.
    \end{experience}
...
\sectitle{Projects}
    ...
    \begin{project}{Machine Learning Soccer Prediction}{https://dsoman24.github.io/ml-project/}{Python, sklearn, PyTorch}{August -- December 2023}
        \item Worked on a team of 5 to train Logistic Regression, Random Forest, and Artificial Neural Network models to predict soccer match outcomes with 70\% accuracy.
        \item Developed feature engineering strategies, performed dimensionality reduction, and conducted hyperparemeter tuning to reduce overfitting, improving model accuracy by $\sim$10\%.
    \end{project}
...
\sectitle{Skills}
    ...
    \vspace{3pt}
    \skill{Technologies}{Java (Including JavaFX, Android Studio), Python (Pandas, NumPy, sklearn, Beautiful Soup), C, SQL, Git, LaTeX, R} \\
