...
{\textbf{\textit{B.S. Computer Science, concentrations in Intelligence (AI/ML) and Theory}} \hfill 4.0/4.0 GPA \\ \textit{Relevant Coursework}: Data Structures \& Algorithms, Machine Learning, Deep Learning, Graduate Algorithms, Computer Organization \& Programming, Probability \& Statistics, Automata \& Complexity, Number Theory}
...
\sectitle{Skills}
    ...
    \vspace{3pt}
    \skill{Technologies}{Java (JUnit), C/C++, Python (Pandas, NumPy, sklearn, PyTorch, Flask), JavaScript (React, Express), SQL} \\
