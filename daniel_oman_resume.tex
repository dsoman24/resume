...
\sectitle{Projects}
    ...
    \begin{project}{Machine Learning Soccer Prediction}{https://dsoman24.github.io/ml-project/}{Python, sklearn, PyTorch}{August -- December 2023}
        ...
        \item Developed feature engineering strategies, and performed dimensionality reduction and hyperparemetr tuning to reduce overfitting, improving model accuracy by $\sim$10\%.
    \end{project}
